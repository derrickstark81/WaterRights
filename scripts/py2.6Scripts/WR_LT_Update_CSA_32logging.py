...
try:
    ...
    log = open("E:\\Updates\\ArcUpdateScriptsLogs\WR_LT_Update_CSA_32logging.txt","a")
    log.write("----------------------------" + "\n")
    log.write("----------------------------" + "\n")
    log.write("Log: " + str(d) + "\n")
    log.write("\n")    
...
# Start process...
    ...
    arcpy.aWRUpdatePointsLandsCSA_ZWRDU()
    print "Ran aWRUpdatePointsLandsCSA successfully."
    arcpy.bWRDailyImportMetadata_ZWRDU()
    print "Ran bWRDailyImportMetadata successfully."
